<div id="contenido">
    <form autocomplete="on" method="post" name="alta_vehicle" id="alta_vehicle" onsubmit="return validate();" action="index.php?page=controller_vehicle&op=create">
            ...
            <tr>
                ...
                <td><font color="red">
                    <span id="error_id_vehicle" class="error">
                        <?php
                            if(isset($error_id_vehicle)){echo $error_id_vehicle;}
                        ?>
                    </span>
                </font></font></td>
            </tr>
            ...
            <tr>
                ...
                <td><font color="red">
                    <span id="error_marca" class="error">
                        <?php
                            if(isset($error_marca)){echo $error_marca;}                        ?>
                    </span>
                </font></font></td>
            </tr>
            ...
            <tr>
                ...
                <td><font color="red">
                    <span id="error_modelo" class="error">
                        <?php
                            if(isset($error_modelo)){echo $error_modelo;}                        ?>
                    </span>
                </font></font></td>
            </tr>
            ...
            <tr>
                ...
                <td><font color="red">
                    <span id="error_HP" class="error">
                        <?php
                           if(isset($error_HP)){echo $error_HP;}
                        ?>
                    </span>
                </font></font></td>
            </tr>
            ...
            <tr>
                ...
                <td><font color="red">
                    <span id="error_Km" class="error">
                        <?php
                           if(isset($error_Km)){echo $error_Km;}
                        ?>
                    </span>
                </font></font></td>
            </tr>
            ...
            <tr>
                ...
                <td><font color="red">
                    <span id="error_Anyo_produccion" class="error">
                        <?php
                           if(isset($error_Anyo_produccion)){echo $error_Anyo_produccion;}
                        ?>
                    </span>
                </font></font></td>
            </tr>
            ...
            <tr>
                ...
                <td><font color="red">
                    <span id="error_color" class="error">
                        <?php
                            if(isset($error_color)){echo $error_color;}
                        ?>
                    </span>
                </font></font></td>
